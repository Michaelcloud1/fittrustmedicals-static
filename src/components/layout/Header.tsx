    ...
    <header className="sticky top-0 z-50 bg-white shadow-sm w-full">
      <div className="border-b border-gray-100 bg-white">
        <div className="container mx-auto px-4 py-3">
          {/* DESKTOP LAYOUT - 3 columns: Logo | Search | Icons */}
          <div className="hidden md:grid md:grid-cols-3 items-center gap-4">
            ...
            {/* Center: Search Bar - Separate column, no overlap */}
          ...
          <div className="md:hidden">
            ...
            {/* Row 2: Search Bar - Full width, below icons */}
            <div className="mt-3">
      ...
      {/* Mobile Account Dropdown - Shows when account icon is clicked */}
      {accountDropdownOpen && (
